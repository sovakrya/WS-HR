...
export interface ApiTaskTask extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    uuid_for_links: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiUuidForLinkUuidForLink extends Struct.CollectionTypeSchema {
  collectionName: 'uuid_for_links';
  info: {
    description: '';
    displayName: 'UUIDForLink';
    pluralName: 'uuid-for-links';
    singularName: 'uuid-for-link';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::uuid-for-link.uuid-for-link': ApiUuidForLinkUuidForLink;
